...
def edit(username):
	...
	render_html = render_template('users/edit.html', title='Account', user=current_user,form=form)
...
def upload_profile_image(username):
	...
	if "image_file" not in request.files:
		...
		rendered_html = render_template('users/edit.html', validation_errors=[], form=form, user=user)
		return html_minify(rendered_html)
	...
	if file.filename == "":
		...
		rendered_html = render_template('edit.html', form=form)
		return html_minify(rendered_html)

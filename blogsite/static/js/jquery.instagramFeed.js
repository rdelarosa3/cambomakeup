        ...
        if(options.display_gallery){
          if(data.is_private){
            ...
            for(var i = 0; i < max; i++){
              ...
              html += "<div class='col-sm-6 col-md-2 col-lg-2 item zoom-on-hover' id='gal"+count+"'>";
              html += "<a data-toggle='lightbox' data-gallery='showcase-gallery' href='"+ imgs[i].node.thumbnail_src +"'> <img src='"+ imgs[i].node.thumbnail_src +"' alt='"+ options.alt_tag +" by SreyNy "+i+"'"+styles.gallery_image+" class='img-fluid image'/></a></div>";
              count += 1;
            }
            html += "</div>";
          }
